...
<table class="easyui-datagrid" id="itemList" title="商品列表"
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'title',width:200,formatter:TAOTAO.formatText">商品标题</th>
			<th data-options="field:'cid',width:100">叶子类目</th>
			<th
				data-options="field:'sellPoint',width:100,formatter:TAOTAO.formatText">卖点</th>
			<th
				data-options="field:'price',width:70,align:'right',formatter:TAOTAO.formatPrice">价格</th>
			<th data-options="field:'num',width:70,align:'right'">库存数量</th>
			<th
				data-options="field:'barcode',width:100,formatter:TAOTAO.formatText">条形码</th>
			<th
					...
					$("#itemEditWindow").window(
							{
								onLoad : function() {
									...
									// 加载商品描述
									$.getJSON('/rest/item/desc/' + data.id,
											function(_data) {
												itemEditEditor
														.html(_data.itemDesc);
											});
